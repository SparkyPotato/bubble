import { ProfileUpdateRequestOptions, StacksProvider } from '@stacks/connect/dist/types/types';
export declare function getDefaultProfileUpdateRequestOptions(options: ProfileUpdateRequestOptions): {
    ...
    onFinish?: import("@stacks/connect/dist/types/types").ProfileUpdateFinished;
    onCancel?: import("@stacks/connect/dist/types/types").ProfileUpdateCanceled;
};
